        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <Card className="w-full max-w-md bg-slate-800/70 backdrop-blur-xl border-slate-700/50 shadow-2xl">
            ...
            <CardContent className="space-y-6">
              <Button
                variant="outline"
                className="w-full h-12 border-slate-600 hover:bg-slate-700/50 hover:border-slate-500 text-slate-300 transition-all"
              ...
              <div className="relative">
                ...
                <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-800 px-4 text-sm text-slate-400">
